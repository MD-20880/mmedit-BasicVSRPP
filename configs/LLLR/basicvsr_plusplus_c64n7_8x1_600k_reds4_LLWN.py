exp_name = 'basicvsr_plusplus_c64n7_8x1_600k_reds4_LLWN'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder=r"D:\Dataset\dataset_REDS\Synthetic4x_LLWithNoise\train",
    ...
    val=dict(
        ...
        lq_folder=r"D:\Dataset\dataset_REDS\Synthetic4x_LLWithNoise\test",
