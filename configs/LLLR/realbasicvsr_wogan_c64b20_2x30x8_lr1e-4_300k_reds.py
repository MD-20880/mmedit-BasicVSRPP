exp_name = 'realbasicvsr_wogan_c64b20_2x30x8_lr1e-4_300k_reds_NLNN'
...
model = dict(
    ...
    generator=dict(
        ...
        dynamic_refine_thres=1.5,#255,  # change to 1.5 for test
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder=r'D:\Dataset\dataset_REDS\Synthetic4x_NLNoNoise\train',
    ...
    test=dict(
        type=val_dataset_type,
        lq_folder=r'D:\Dataset\dataset_REDS\Synthetic4x_NLWithNoise\test',
        gt_folder='D:\\Dataset\\dataset_REDS\\groundtruth\\test',
        num_input_frames=100,
